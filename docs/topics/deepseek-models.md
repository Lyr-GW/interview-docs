...
!!! abstract "30 秒速览"
    - DeepSeek 是由量化对冲基金 High‑Flyer 孵化的中国 AI 研究公司，以开源高效大模型著称
    - 其最新 DeepSeek‑V4 系列通过混合压缩注意力（CSA/HCA）、流形约束超连接（mHC）和 Muon 优化器三项架构创新，在 100 万 token 长度上把推理 FLOPs 和 KV 缓存压缩至上一代 V3.2 的 10%–27
    - !!! abstract "30 秒速览"
    - (核心要点从上文提取)
